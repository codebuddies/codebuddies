...
if (Meteor.isServer) {
    ...
    hangoutReminder = function() {
            ...
            if (active_hangouts.length > 0) {
              console.log("found a hangout to send reminder!");
                active_hangouts.forEach(function(hangout) {
                        //if there are no attendees breaking the loop
                        ...
                        if (time_diff <= 2) { // let's alert on Slack channel and email
                            ...
                            hangoutAlert(data);
                            // update hangout and set is_reminder_sent = true
                            Hangouts.update({
                                _id: hangout._id
                            }, {
                                $set: {
                        ...
                        } else if (time_diff > 2 && time_diff <= 24) {
