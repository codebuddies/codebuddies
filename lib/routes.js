...
admin.route('/', {
  name: 'admin',
  action: function() {
    FlowLayout.render('adminLayout',{content: 'adminLanding'});
  }
});
...
admin.route('/dashboard', {
  name: 'dashboard',
  action: function() {
    FlowLayout.render('adminLayout',{content: 'isAdmin', targetTemplate: 'dashboard'})
  }
});
admin.route('/users', {
  name: 'manage user',
  action: function() {
    FlowLayout.render('adminLayout',{content: 'isAdmin', targetTemplate: 'manageUser'})
  }
});
admin.route('/users/:role', {
  name: 'moderator',
  action: function() {
    FlowLayout.render('adminLayout',{content: 'isAdmin', targetTemplate: 'usersByRole'})
  }
});
admin.route('/user/:userId', {
  name: 'user',
  action: function() {
    FlowLayout.render('adminLayout',{content: 'isAdmin', targetTemplate: 'userById'})
  }
});
admin.route('/notifications', {
  name: 'notifications',
  action: function() {
    FlowLayout.render('adminLayout',{content: 'isAdmin', targetTemplate: 'allNotification'})
  }
});
