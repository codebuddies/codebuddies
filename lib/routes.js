...
FlowRouter.route('/hangouts', {
  name: 'hangouts',
  action: function(params, queryParams) {
    BlazeLayout.render('layout', { top: 'header', main: 'hasBlocked', targetTemplate: 'homeLoggedIn', footer: 'footer' });
  }
});
...
FlowRouter.route('/hangout-faq', {
  name: 'hangout-faq',
  action: function(params, queryParams) {
    BlazeLayout.render('layout', { top: 'header', main: 'hangoutFAQModal', footer: 'footer' });
  }
});
...
FlowRouter.route('/terms-of-service', {
  name: 'termsOfService',
  action: function(params, queryParams) {
    BlazeLayout.render('layout', {top: 'header', main: 'termsOfService', footer: 'footer'});
  }
});
...
FlowRouter.route('/my-study-groups', {
  ...
  action: function(params, queryParams) {
    BlazeLayout.render('layout', { top: 'header', main: 'hasBlocked', targetTemplate: 'myStudyGroups', footer: 'footer' });
  }
});
...
FlowRouter.route('/study-groups', {
  ...
  action: function(params, queryParams) {
    BlazeLayout.render('layout', { top: 'header', main: 'hasBlocked', targetTemplate: 'allStudyGroups', footer: 'footer' });
  }
});
...
FlowRouter.route('/study-groups/owners-guide', {
  ...
  action: function(params, queryParams) {
    BlazeLayout.render('layout', { top: 'header', main: 'studyGroupOwnersGuide', footer: 'footer' });
  }
});
...
FlowRouter.route('/study-group/:studyGroupSlug/:studyGroupId', {
  name: 'study group',
  action: function(params, queryParams) {
    BlazeLayout.render('layout', { top: 'header', main: 'hasBlocked', targetTemplate: 'singleStudyGroup', footer: 'footer' });
  },
...
FlowRouter.route('/log/:logId', {
  name: 'single progress log',
  action: function(params, queryParams) {
    BlazeLayout.render('layout', { top: 'header', main: 'hasBlocked', targetTemplate: 'singleProgressLog', footer: 'footer' });
  }
});
...
FlowRouter.route('/discussion/:discussionId', {
  ...
  action: function(params, queryParams) {
    ...
    BlazeLayout.render('layout', { top: 'header', main: 'hasBlocked', targetTemplate: 'discussion', footer: 'footer' });
  }
});
...
FlowRouter.route('/discussions', {
  name: 'discussions',
  action: function(params, queryParams) {
    BlazeLayout.render('layout', { top: 'header', main: 'hasBlocked', targetTemplate: 'allDiscussions', footer: 'footer' });
  }
});
...
FlowRouter.route('/slack', {
  name: 'slack',
  action: function(params, queryParams) {
    BlazeLayout.render('layout', { top: 'header', main: 'slack', footer: 'footer' });
  }
});
...
sys.route('/', {
  name: 'admin',
  action: function() {
    BlazeLayout.render('sysLayout', { top: 'sysHeader', main: 'hasPermission', targetTemplate: 'adminLanding' });
  }
});
