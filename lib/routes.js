...
admin.route('/dashboard', {
  name: 'dashboard',
  action: function() {
    FlowLayout.render('adminLayout',{content: 'dashboard'})
  }
});
admin.route('/users', {
  name: 'manage user',
  action: function() {
    FlowLayout.render('adminLayout',{content: 'manageUser'})
  }
});
admin.route('/users/moderator', {
  name: 'moderator',
  action: function() {
    FlowLayout.render('adminLayout',{content: 'moderator'})
  }
});
admin.route('/users/all', {
  name: 'user',
  action: function() {
    FlowLayout.render('adminLayout',{content: 'allUser'})
  }
});
admin.route('/user/:userId', {
  name: 'user',
  action: function() {
    FlowLayout.render('adminLayout',{content: 'userById'})
  }
});
admin.route('/notifications', {
  name: 'notifications',
  action: function() {
    FlowLayout.render('adminLayout',{content: 'allNotification'})
  }
});
