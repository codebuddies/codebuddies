...
describe("QuillEditor", () => {
  ...
  describe("createEditor", () => {
    var hostElement, editor, container;
    ...
    describe("setContents()", () => {
      it("should reflect the contents when setting with string", function() {
        ...
        QuillEditor.generateHTMLForDeltas(editor.getContents()).should.be.equal(
          "<p>hello 123</p><p></p>"
        );
      });
  ...
  describe("generateHTMLForDeltas", () => {
    var delta = {
      ...
      expectedHTML =
        '<p>this is some text <a href="https://codebuddies.org/">https://codebuddies.org/</a></p><p></p>';
