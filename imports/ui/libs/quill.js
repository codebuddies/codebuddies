        ...
        function shiftRange(range, index, length, source) {
          ...
          if (index instanceof _delta2.default) {
            ...
            var _map3 = [range.index, range.index + range.length].map(function(pos) {
              if (pos < index || (pos === index && source !== _emitter2.default.sources.USER))
                return pos;
              if (length >= 0) {
                return pos + length;
              } else {
          ...
          _createClass(Editor, [
            ...
            },
            {
              ...
              value: function formatLine(index, length) {
                ...
                this.scroll.optimize();
                return this.update(
                  new _delta2.default().retain(index).retain(length, (0, _clone2.default)(formats)),
                  source
                );
              }
            },
            ...
            },
            {
              ...
              value: function insertEmbed(index, embed, value) {
                ...
                return this.update(
                  new _delta2.default().retain(index).insert(_defineProperty({}, embed, value)),
                  source
                );
              }
            },
            {
              ...
              value: function insertText(index, text) {
                ...
                return this.update(
                  new _delta2.default().retain(index).insert(text, (0, _clone2.default)(formats)),
                  source
                );
              }
            },
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var Embed = (function(_Parchment$Embed) {
          ...
          function Embed() {
            ...
            return _possibleConstructorReturn(
              this,
              (Embed.__proto__ || Object.getPrototypeOf(Embed)).apply(this, arguments)
            );
          }
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var Selection = (function() {
          function Selection(scroll, emitter) {
            ...
            ["keyup", "mouseup", "mouseleave", "touchend", "touchleave", "focus", "blur"].forEach(
              function(eventName) {
              ...
              value: function scrollIntoView() {
                ...
                if (this.root.offsetHeight < bounds.bottom) {
                  var _scroll$line = this.scroll.line(
                    Math.min(range.index + range.length, this.scroll.length() - 1)
                  );
                  ...
                  this.root.scrollTop =
                    line.domNode.offsetTop + line.domNode.offsetHeight - this.root.offsetHeight;
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function matchAlias(format, node, delta) {
          return delta.compose(
            new _delta2.default().retain(delta.length(), _defineProperty({}, format, true))
          );
        }
            ...
            [
              {
                ...
                value: function create(value) {
                  ...
                  return _get(List.__proto__ || Object.getPrototypeOf(List), "create", this).call(
                    this,
                    value
                  );
                }
            ...
            },
            {
              ...
              value: function update() {
                ...
                if (this.select.selectedIndex > -1) {
                  var item = this.container.querySelector(".ql-picker-options").children[
