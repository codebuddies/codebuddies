  ...
  !(function() {
    ...
    (e.TimePicker = function() {
      ...
      (e.TimePicker.instance = function() {
        return (
          e.TimePicker._instance || (e.TimePicker._instance = new e.TimePicker()),
      ...
      (e.TimePicker.prototype = {
        ...
        previous: function(e) {
          return (
            (this.closed() || this.instance === e) && this._move(e, "prev", ".ui-menu-item:last"),
            e.element
          );
        },
        first: function(e) {
        ...
        open: function(t) {
          ...
          switch (
            ...
            e(i).bind("click.timepicker-" + t.element.data("timepicker-event-namespace"), function(
              e
            ) {
        ...
        setTime: function(t, i, r) {
          var a = this,
            o = t.selectedTime;
          if (
            ("string" == typeof i && (i = t.parse(i)), i && i.getMinutes && a._isValidTime(t, i))
          ) {
            if (
              ((i = n(i)),
              (t.selectedTime = i),
