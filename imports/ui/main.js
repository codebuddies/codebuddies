...
import "./components/other/has_blocked";
import "./components/home/home_logged_out";
...
if (Meteor.isClient) {
  Meteor.startup(function() {
    ...
    const browserLang = (window.navigator.userLanguage || window.navigator.language || "").slice(
      0,
      2
    );
...
Template.registerHelper("isOwnerOfTheGroup", function(userId, groupId) {
  ...
  return loggedInUserId !== userId && Roles.userIsInRole(loggedInUserId, ["owner"], groupId)
    ? true
    : false;
});
