Template.hangoutFAQModal.onCreated(function(){
  ...
  DocHead.addMeta(metaInfo);  DocHead.setTitle('CodeBuddies | Hangout FAQ');
});

Template.hangoutFAQModal.onRendered(function() {
  $(function() {
      let currentUrl = window.location.href;
      if (currentUrl.indexOf("hangout-faq") > -1) {
          $("#hangout-faq-modal").removeClass('modal fade');
